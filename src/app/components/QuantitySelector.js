...
const QuantitySelector = ({ quantity, handleIncrement, handleDecrement, handleQuantityChange, handleBlur, disabled, inputAllowed= true }) => {
    return (
        <div className="mt-6 mb-4">
            ...
            <div className="flex items-center space-x-4">
                ...
                <input
                    ...
                    disabled={disabled && inputAllowed}
                />
                <button
                    type="button"
